	...
	String rarfilePath = request.getParameter("rarFile");		//获取RAR文件路径
 	...
 	if(submit!=null){//判断是否提交表单
 		if(filePath!=null&&!filePath.equals("")&&
 			...
 			fileUtil.enRarFile(rarfilePath,filePath);
 			out.println("<script>alert('文件解压缩成功！');</script>");	
	 	}
 	}
  %>  
...
<input type="hidden" name="rarFile" id="rarFile">
	<table border="0" width="500" background="bg.JPG">
		...
		<tr>
			...
			<td  align="right"></td>
			<td >
				<input type="submit" name="submit" onclick="getFilePath()" value="开始解压"/>
			</td>
		</tr>
	</table>
	</form>
