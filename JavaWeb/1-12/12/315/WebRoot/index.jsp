	...
	String volumeSize = request.getParameter("volumeSize");		//分卷大小
 	...
 	if(submit!=null){//判断是否提交表单
 		if(filePath!=null&&!filePath.equals("")&&
 			...
 			fileUtil.toRarFile(filePath,rarfilePath,Integer.parseInt(volumeSize));
 			out.println("<script>alert('文件分卷压缩成功！');</script>");	
	 	}
 	}
  %>  
...
<input type="hidden" name="rarFile" id="rarFile">
	<table border="0" width="508" background="bg.JPG">
		...
		<tr>
			<td width="40"> 	</td>
			<td  align="right">&nbsp;分卷：</td>
			<td ><input type="text" name="volumeSize" id="volumeSize" size="10" />KB
			</td>
		</tr>
		<tr>
			<td  align="right"></td>
